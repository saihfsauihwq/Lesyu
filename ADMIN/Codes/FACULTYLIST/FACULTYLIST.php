    ...
    <div class="main-container">
        <div class="table">
            <h1 class="Head">List of Account registered
                <a href="http://localhost/WRRL/ADMIN/Codes/USERLIST/USERLIST.php" class="button">STUDENT</a>
                <a style="background-color: rgb(164,0,1); color: white;" href="http://localhost/WRRL/ADMIN/Codes/FACULTYLIST/FACULTYLIST.php" class="button">FACULTY</a>
        </h1>

        <form action="FACULTYLIST.php" method="get">
            <div class="Searchbar">
            ...
            <table>
                <tr>
                    ...
                    <th class="Uploaded">Uploads Article</th>
                </tr>
                <?php
                ...
                foreach ($userData as $row) {
                    ...
                    echo "<td class='Fname'><a href='http://localhost/WRRL/ADMIN/Codes/facprofile/profile.php?ID=" . $row['ID_number'] . "'>";
                    ...
                    echo "</select>";
                    echo "</form>";
                    echo "<td class='Uploaded'><a href='http://localhost/WRRL/ADMIN/Codes/fac_uploads/myupload.php?ID=" . $row['ID_number'] . "' class='view'>View Uploads</a></td>";                  
                    echo "</td>";
                    echo "</tr>";
                }
                ?>
