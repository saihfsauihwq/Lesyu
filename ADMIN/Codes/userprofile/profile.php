...
if ($userData) {
    $userprofileBlob = $userData["Profile"];
  }
    ...
    <div class="main-container">
        <div class="table">
            <div class="background">
                ...
                <a class="edit" href="/WRRL/ADMIN/CODES/Userupdateinfo/UpdateProfile.php?ID=<?php echo $userData['ID_number']; ?>">Edit</a>
                <img class="profimg" src="data:image/jpeg;base64,<?php echo base64_encode($userprofileBlob); ?>">
                    <div class="ID-number"><label>ID-number</label><span><?php echo $userData['ID_number']; ?></span></div>
                    <div class="Profile-Info">
                        <div class="Info-Column">
                            <div class="Info-Item"><label>Name:</label><span><?php echo $userData['Firstname'] . ' ' . $userData['Lastname']; ?></span></div>
                            <div class="Info-Item"><label>Gender:</label><span><?php echo $userData['Gender']; ?></span></div>
                            <div class="Info-Item"><label>Email:</label><span><?php echo $userData['Liceo_Email']; ?></span></div>
                            <div class="Info-Item"><label>Backup Email:</label><span><?php echo $userData['Backup_email']; ?></span></div>
                        </div>
                        <div class="Info-Column">
                            <div class="Info-Item"><label>Grade Section:</label><span><?php echo $userData['Grade_Section']; ?></span></div>
                            <div class="Info-Item"><label>Strand:</label><span><?php echo $userData['Strand']; ?></span></div>
                            <div class="Info-Item"><label>Status:</label><span><?php echo $userData['EStatus']; ?></span></div>
                            <div class="Info-Item"><label>Year graduated:</label><span><?php echo $userData['Year_grad']; ?></span></div>
                        </div>
                    </div>
                </div>
            </div>
