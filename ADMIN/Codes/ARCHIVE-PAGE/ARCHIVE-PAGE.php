    ...
    <div class="Navigation-bar-container">
        <div class="profile">
            ...
            <div class="nav-buttons">
                ...
                <div><img src="/WRRL/IMAGES/folders.png"><a style="color: rgb(164,0,1); text-decoration: underline;" class="publish" href="/WRRL/ADMIN/Codes/ARCHIVE-PAGE/ARCHIVE-PAGE.php">Archives</a></div>
...
<main>
    ...
    <div>
    <a style="background-color: rgb(164, 0, 1); color: white;" class="pub-button" href="/WRRL/ADMIN/Codes/ARCHIVE-PAGE/ARCHIVE-PAGE.php">Published</a>
    <a class="pub-button" href="/WRRL/ADMIN/Codes/ARCHIVE-PAGE2/ARCHIVE-PAGE2.php">Not Published</a>
    </div>

<form action="ARCHIVE-PAGE.php" method="get">
    <div class="Searchbar">
        ...
        if (empty($latestResearchData)) {
            ...
            foreach ($latestResearchData as $research) {
                ...
                echo '<a class="Research-Paper-title" href="/WRRL/ADMIN/Codes/ARCHIVE-ABSTRACT-PAGE/ABSTRACT-PAGE.php?uid=' . $research['UID'] . '">' . $research['RTitle'] . '</a>';
                ...
                echo '<p class="Deleted"> Deleted By: ' . $research['Deleter'] . '</p>';
                echo '</div>';
                echo '</div>';
            }
        }
