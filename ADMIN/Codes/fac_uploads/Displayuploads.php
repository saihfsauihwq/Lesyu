...
function getLatestResearchData($facultyID, $offset = 0, $limit = 5, $searchQuery = "",  $pubStat = "ALL",  $start_date = "", $end_date = "") {
    $DbHost = "localhost";
    $DbUsername = "root";
    $DbPassword = "";
    ...
    $query = "SELECT strands_list.Strand_name, RTitle, Authors, Date, Abstract, UID, Publish_status
              ...
              WHERE research_info.Uploader_ID = '$facultyID'"
  ...
  function getTotalResearchCount($facultyID, $searchQuery = "", $pubStat = "ALL", $start_date = "", $end_date = "") {
    $DbHost = "localhost";
    $DbUsername = "root";
    $DbPassword = "";
    $DbName = "researchfiledb";
