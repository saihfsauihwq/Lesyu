...
$userInfo = getUserInfo($facultyID);
...
<main>
  <div class="Research-con">
    ...
    <?php
        ...
        $totalItems = getTotalResearchCount($facultyID, $searchQuery, $pubStat, $startDate, $endDate); 
        ...
        $latestResearchData = getLatestResearchData($facultyID, $offset, $itemsPerPage, $searchQuery, $pubStat, $startDate, $endDate);
    ?>

        <h1 class="Latest-Research-Heading"><?php echo $userInfo['Firstname']; ?>'s Uploads</h1>
        ...
        <form action="myupload.php" method="get">
            <div class="Searchbar">
                ...
                <input class="type" type="text" name="query" value="<?php echo htmlspecialchars($searchQuery); ?>" placeholder="Search in <?php echo $userInfo['Firstname']; ?>'s uploads">
