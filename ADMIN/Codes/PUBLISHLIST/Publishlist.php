...
<main>
    ...
    <h1 class="head">Published</h1>
    <div>
    <a style="background-color: rgb(164, 0, 1); color: white;" class="pub-button" href="/WRRL/ADMIN/Codes/PUBLISHLIST/Publishlist.php">Published</a>
    <a class="pub-button" href="/WRRL/ADMIN/Codes/NOTPUBLISHLIST/NOTPublishlist.php">Not Published</a>
    </div>
