    ...
    <script>
        ...
        window.onload = function() {
            ...
            if ($passwordUpdated) {
                ...
                echo 'window.location.href = "http://localhost/WRRL/FAC/Codes/Profile/Profile.php";';
            }
            ?>
        };
    </script>
...
<nav>
  <div class="Nav-Section">
    ...
    <li><a class="nav_bar" href="http://localhost/WRRL/FAC/Codes/Publish/Publish.php">Upload new Paper</a></li>
      <li style="background-color: rgba(148, 147, 144, 0.153);"><a class="nav_bar" href="http://localhost/WRRL/FAC/Codes/Update/Update.php">Update Account</a></li>
