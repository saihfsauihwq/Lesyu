...
include '/xampp/htdocs/WRRL/FAC/CODES/Verification_page/verfication_process.php';
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($verification_code) {
        ...
        if ($result === true) {
            ...
            echo 'window.location.href = "http://localhost/WRRL/FAC/Codes/LOGIN-PAGE/LOGIN-PAGE.php";';
            echo '</script>';
            exit();
        } else {
