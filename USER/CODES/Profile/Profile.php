 ...
 <main>
  ...
  <div class="background">
      <div class="Profile-Page">
        ...
        <a class="edit" href="/WRRL/USER/CODES/Updateinfo/UpdateProfile.php">Edit</a>
        ...
        <div class="Profile-Info">
          ...
          <div class="Info-Column">
          <div class="Info-Item"><label>Grade Section:</label><span><?php echo $userInfo['Grade_Section']; ?></span></div>
            <div class="Info-Item"><label>Strand:</label><span><?php echo $userInfo['Strand']; ?></span></div>
            <div class="Info-Item"><label>Status:</label><span><?php echo $userInfo['EStatus']; ?></span></div>
            <div class="Info-Item"><label>Year graduated:</label><span><?php echo $userInfo['Year_grad']; ?></span></div>
          </div>
        </div>
      </div>
    </div>
