      ...
      <main>
        <div class="Container">
          <div class="Terms">
            ...
            <p>Welcome to LiceoRepo!</p>
            <br>
            <p>These terms and conditions outline the rules and regulations for the use of LiceoRepo's Website, located at liceorepo.edu.ph.</p>
            <br>
            <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use LiceoRepo if you do not agree to take all of the terms and conditions stated on this page.</p>
            <br>
            <p>The following terminology applies to these Terms and Conditions, 
              ...
              law of ph. Any use of the above terminology or other words in the singular, plural, 
