...
<body>
 ...
 <main>
    ...
    <ul class="Navigator">
        ...
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-HE/HOME-PAGE-HE.php" style=" Color: rgb(164,0,1);">Home Economics</a>
        </li>
        <li class="nav-text" >
    ...
    <h1 class="Latest-Research-Heading" >Home Economics</h1>

        <form action="HOME-PAGE-HE.php" method="get">
            <div class="Searchbar">
