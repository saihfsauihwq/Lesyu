...
<body>
    ...
    <header>
        <div class="Header-background">
            ...
            <?php 
                include("/xampp/htdocs/WRRL/USER/Codes/Assets/profilebutton.php");
                ?>
        </div>
    </header>
 ...
 <main>
    ...
    <ul class="Navigator">
        <li class="nav-text">
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE/HOME-PAGE.php">Home</a>
        </li>
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-STEM/HOME-PAGE-STEM.php" style=" Color: rgb(164,0,1);">Science, Technology, Engineering, and Mathematics</a>
        </li>
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-ABM/HOME-PAGE-ABM.php">Accountancy, Business and Management</a>
        </li>
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-ICT/HOME-PAGE-ICT.php">Information and Communications Technology</a>
        </li>
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-HE/HOME-PAGE-HE.php">Home Economics</a>
        </li>
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-FAC/HOME-PAGE-FAC.php"> Senior High School Faculty</a>
        </li>
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/Volume/volume.php?volume=<?php echo $selectedVolume; ?>">Volumes</a>
        </li>
    </ul>
</nav>
    ...
    <h1 class="Latest-Research-Heading">Science, Technology, Engineering, and Mathematics</h1>

        <form action="HOME-PAGE-STEM.php" method="get">
            <div class="Searchbar">
                ...
                <input class="type" type="text" name="query" value="<?php echo htmlspecialchars($searchQuery); ?>" placeholder="Search in STEM">
    ...
    <div class="Latest-Research-Container">
        ...
        if (empty($latestResearchData)) {
            ...
            foreach ($latestResearchData as $research) {
                ...
                echo '<a class="Research-Paper-title" href="/WRRL/USER/Codes/ABSTRACT-PAGE/ABSTRACT-PAGE.php?uid=' . $research['UID'] . '">' . $research['RTitle'] . '</a>';
