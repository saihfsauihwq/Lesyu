...
<body>
 ...
 <main>
    ...
    <ul class="Navigator">
        ...
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-FAC/HOME-PAGE-FAC.php" style=" Color: rgb(164,0,1);">Senior High School Faculty</a>
        </li>
        <li class="nav-text" >
    ...
    <h1 class="Latest-Research-Heading" >Senior High School Faculty</h1>

        <form action="HOME-PAGE-FAC.php" method="get">
            <div class="Searchbar">
