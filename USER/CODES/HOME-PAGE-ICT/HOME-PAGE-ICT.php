...
<body>
 ...
 <main>
    ...
    <ul class="Navigator">
        ...
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-STEM/HOME-PAGE-STEM.php" >Science, Technology, Engineering, and Mathematics</a>
        </li>
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-ABM/HOME-PAGE-ABM.php">Accountancy, Business and Management</a>
        </li>
        <li class="nav-text" >
            <a class="nav-text" href="/WRRL/USER/Codes/HOME-PAGE-ICT/HOME-PAGE-ICT.php" style=" Color: rgb(164,0,1);">Information and Communications Technology</a>
        </li>
        <li class="nav-text" >
    ...
    <h1 class="Latest-Research-Heading">Information and Communications Technology</h1>

        <form action="HOME-PAGE-ICT.php" method="get">
            <div class="Searchbar">
                ...
                <input class="type" type="text" name="query" value="<?php echo htmlspecialchars($searchQuery); ?>" placeholder="Search in ICT">
