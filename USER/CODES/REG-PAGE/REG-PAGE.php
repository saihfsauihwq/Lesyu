...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result === true) {
        ...
        header("Location: http://localhost/WRRL/USER/Codes/Verification_page/Verification.php?email=" . urlencode($email));
        exit();
    } else {
      ...
      <main>
        ...
        <form action="REG-PAGE.php" method="post" enctype="multipart/form-data">
          <div class="Reg-Form">
            ...
            <div class="Column3">
            <div class="Profileup">
                <label for="UploadProfile" style="Margin-top: 0;">
                    <img id="Displayimg" src="/WRRL/USER/Images/profile-icon-png-898.png"><br>Select Profile
                </label>
                ...
                <div class="column1">
                  ...
                  <input id="grade" name="grade" class="type-box" type="text" placeholder="-">
                ...
                <div class="column2">
                  ...
                  <select class="Year" name="year" id="Year" >
                    ...
                    <option value="">-</option>
                    <script>
                      for (var year = 1999; year <= 2099; year++) {
                        if (year === 2024) {
